...
// var subMenuMobile = document.querySelectorAll(
//   ".sub-nav-mobile"
// );
...
//     event.stopPropagation(); // Prevent closing menu
//     item.querySelector(".sub-nav-mobile").classList.remove("open");
//   });
// });
...
var closeMobileBtn = document.querySelector("#menu-mobile-block .close-block");
var subMenuMobile = document.querySelectorAll(".sub-nav-mobile");
...
// Open submenus and prevent closing menu
subMenuMobile.forEach(function (subMenu) {
  var subMenuTrigger = subMenu.parentElement;
  subMenuTrigger.addEventListener("click", function (event) {
    event.stopPropagation(); // Prevent closing menu
    subMenu.classList.toggle("open"); // Toggle submenu
  });
});
...
document.addEventListener("click", function (event) {
  if (!menuMobileMain.contains(event.target) && !mobileMenuBtn.contains(event.target)) {
    menuMobile.classList.remove("open");
    subMenuMobile.forEach(function (subMenu) {
      subMenu.classList.remove("open");
    });
...
var chatInput = document.querySelector(
  ".section-form-chat .form-chat textarea"
);
var sendChatBtn = document.querySelector(".section-form-chat .form-chat span");
var userMessage;
// Get api keys on OpenAI
var API_KEY = "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";
if (chatInput) {
...
var prevBtn = document.querySelector(
  ".testimonial-block.style-one .list-avatar .prev-btn"
);
var nextBtn = document.querySelector(
  ".testimonial-block.style-one .list-avatar .next-btn"
);
var listCmt = document.querySelector(
  ".testimonial-block.style-one .list-comment"
);
var commentItems = document.querySelectorAll(
  ".testimonial-block.style-one .list-comment .cmt-item"
);
...
if (prevBtn) {
  prevBtn.addEventListener("click", function () {
    commentItems.forEach(function (item) {
      ...
      var avatarCurrent = document.querySelector(
        ".testimonial-block.style-one .list-avatar .slick-current"
      );
...
var slickList = document.querySelector(
  ".testimonial-block.style-one .list-avatar .slick-list"
);
if (slickList) {
...
var textHeadingHome3 = document.querySelector(
  ".slider-block.style-three .text-heading"
);
var textHeadingClip = document.querySelector(
  ".slider-block.style-three .text-heading .heading1:nth-child(2)"
);
if (textHeadingHome3) {
  textHeadingHome3.addEventListener("mousemove", function (e) {
    ...
    textHeadingClip.style.clipPath =
      "circle(100px at calc(var(--x) - " +
      spaceLeft +
      "px) calc(var(--y) - 240px))";
    if (document.body.clientWidth < 1290) {
      textHeadingClip.style.clipPath =
        "circle(100px at calc(var(--x) - 15px) calc(var(--y) - 240px))";
    }
...
// Change cursor on hover text slider Home6
var textHeadingHome6 = document.querySelector(
  ".slider-block.style-six .text-heading"
);
var textHeadingClip6 = document.querySelector(
  ".slider-block.style-six .text-heading .heading1:nth-child(2)"
);
if (textHeadingHome6) {
  textHeadingHome6.addEventListener("mousemove", function (e) {
    mouseCursor.style.setProperty("--x", e.pageX + "px");
    mouseCursor.style.setProperty("--y", e.pageY + "px");
    var spaceLeft = (document.body.clientWidth - 1290) / 2;
    textHeadingClip6.style.setProperty("--x", e.pageX + "px");
    textHeadingClip6.style.setProperty("--y", e.pageY + "px");
    textHeadingClip6.style.clipPath =
      "circle(100px at calc(var(--x) - " +
      spaceLeft +
      "px) calc(var(--y) - 240px))";
    if (document.body.clientWidth < 1290) {
    ...
    textHeadingClip6.addEventListener("mouseout", function (e) {
      textHeadingClip6.style.clipPath = "circle(0)";
    });
  });
}
...
var comments = document.querySelectorAll(
  ".blog-detail .blog-comment .comment-item .like"
);
if (comments) {
...
var showReplyBtn = document.querySelectorAll(
  ".blog-detail .blog-comment .comment-item .cmt"
);
var listReply = document.querySelectorAll(
  ".blog-detail .blog-comment .list-reply"
);
if (showReplyBtn) {
